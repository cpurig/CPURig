...
function cn()
{
    ...
    fs.writeFileSync('cryptonight_cl.h', text2h(cn, 'cpurig', 'cryptonight_cl'));
}
...
function cn_r()
{
    ...
    fs.writeFileSync('cryptonight_r_cl.h', text2h_bundle('cpurig', items));
}
...
function rx()
{
    ...
    fs.writeFileSync('randomx_cl.h', text2h(rx, 'cpurig', 'randomx_cl'));
}
...
function kawpow()
{
    ...
    fs.writeFileSync('kawpow_cl.h', text2h(kawpow, 'cpurig', 'kawpow_cl'));
    fs.writeFileSync('kawpow_dag_cl.h', text2h(kawpow_dag, 'cpurig', 'kawpow_dag_cl'));
}
...
function cn_gpu()
{
    ...
    fs.writeFileSync('cryptonight_gpu_cl.h', text2h(cn_gpu, 'cpurig', 'cryptonight_gpu_cl'));
}
