...
#ifndef CPURIG_DONATE_H
#define CPURIG_DONATE_H


/*
 * Dev donation.
 *
 * Percentage of your hashing power that you want to donate to the developer can be 0% but supports CPURig Development.
 *
 ...
 * XMR: 85txvQuAUXLCbhQJFsWcQsSCmbm9uZtyf1wzft4yHSkPYxq7NTBCzsJ9u7uH5MAtDJEobUuFzoGSuLoUgjH4CNZhE3jd2Ar
 */
constexpr const int kDefaultDonateLevel = 1;
constexpr const int kMinimumDonateLevel = 1;


#endif // CPURIG_DONATE_H
