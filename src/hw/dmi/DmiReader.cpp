...
rapidjson::Value cpurig::DmiReader::toJSON(rapidjson::Document &doc) const
{
    rapidjson::Value obj;
    toJSON(obj, doc);
...
void cpurig::DmiReader::toJSON(rapidjson::Value &out, rapidjson::Document &doc) const
{
...
bool cpurig::DmiReader::decode(uint8_t *buf, const Cleanup &cleanup)
{
...
bool cpurig::DmiReader::decode(uint8_t *buf)
{
    if (!buf) {
        return false;
    }
