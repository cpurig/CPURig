...
std::shared_ptr<cpurig::Msr> cpurig::Msr::get()
{
...
bool cpurig::Msr::write(uint32_t reg, uint64_t value, int32_t cpu, uint64_t mask, bool verbose)
{
...
cpurig::MsrItem cpurig::Msr::read(uint32_t reg, int32_t cpu, bool verbose) const
{
    uint64_t value = 0;
