...
cpurig::Algorithm::Id cpurig::RxAlgo::apply(Algorithm::Id algorithm)
{
...
const RandomX_ConfigurationBase *cpurig::RxAlgo::base(Algorithm::Id algorithm)
{
    switch (algorithm) {
...
uint32_t cpurig::RxAlgo::version(Algorithm::Id algorithm)
{
    return algorithm == Algorithm::RX_WOW ? 103 : 104;
}


uint32_t cpurig::RxAlgo::programCount(Algorithm::Id algorithm)
{
    return base(algorithm)->ProgramCount;
}


uint32_t cpurig::RxAlgo::programIterations(Algorithm::Id algorithm)
{
    return base(algorithm)->ProgramIterations;
}


uint32_t cpurig::RxAlgo::programSize(Algorithm::Id algorithm)
{
