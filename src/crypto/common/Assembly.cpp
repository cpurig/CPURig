...
cpurig::Assembly::Id cpurig::Assembly::parse(const char *assembly, Id defaultValue)
{
...
cpurig::Assembly::Id cpurig::Assembly::parse(const rapidjson::Value &value, Id defaultValue)
{
    if (value.IsBool()) {
...
const char *cpurig::Assembly::toString() const
{
    return asmNames[m_id];
}


rapidjson::Value cpurig::Assembly::toJSON() const
{
