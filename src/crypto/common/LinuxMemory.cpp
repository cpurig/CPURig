...
bool cpurig::LinuxMemory::reserve(size_t size, uint32_t node, size_t hugePageSize)
{
...
bool cpurig::LinuxMemory::write(const char *path, uint64_t value)
{
...
int64_t cpurig::LinuxMemory::read(const char *path)
{
