...
static const cpurig::CnHash cnHash;


cpurig::CnHash::CnHash()
{
...
cpurig::cn_hash_fun cpurig::CnHash::fn(const Algorithm &algorithm, AlgoVariant av, Assembly::Id assembly)
{
