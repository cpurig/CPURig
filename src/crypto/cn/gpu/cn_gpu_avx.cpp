...
template void cn_gpu_inner_avx<cpurig::CnAlgo<cpurig::Algorithm::CN_GPU>().iterations(), cpurig::CnAlgo<cpurig::Algorithm::CN_GPU>().mask()>(const uint8_t* spad, uint8_t* lpad);
