...
int cpu_flags_has_avx2()    { return cpurig::has_avx2(); }
int cpu_flags_has_avx512f() { return cpurig::has_avx512f(); }
int cpu_flags_has_sse2()    { return cpurig::has_sse2(); }
int cpu_flags_has_ssse3()   { return cpurig::has_ssse3(); }
int cpu_flags_has_xop()     { return cpurig::has_xop(); }
...
cpurig::BasicCpuInfo::BasicCpuInfo() :
...
const char *cpurig::BasicCpuInfo::backend() const
{
    return "basic/1";
}


cpurig::CpuThreads cpurig::BasicCpuInfo::threads(const Algorithm &algorithm, uint32_t limit) const
{
...
rapidjson::Value cpurig::BasicCpuInfo::toJSON(rapidjson::Document &doc) const
{
