...
cpurig::CpuThreads::CpuThreads(const rapidjson::Value &value)
{
    if (value.IsArray()) {
...
cpurig::CpuThreads::CpuThreads(size_t count, uint32_t intensity)
{
...
bool cpurig::CpuThreads::isEqual(const CpuThreads &other) const
{
...
rapidjson::Value cpurig::CpuThreads::toJSON(rapidjson::Document &doc) const
{
