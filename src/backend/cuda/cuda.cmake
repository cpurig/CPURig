if (BUILD_STATIC AND CPURIG_OS_UNIX AND WITH_CUDA)
...
if (WITH_CUDA)
    add_definitions(/DCPURIG_FEATURE_CUDA)
   ...
   if (WITH_NVML AND NOT APPLE)
       add_definitions(/DCPURIG_FEATURE_NVML)
       ...
       remove_definitions(/DCPURIG_FEATURE_NVML)
   endif()
   ...
   if (WITH_KAWPOW)
    ...
    remove_definitions(/DCPURIG_FEATURE_CUDA)
    remove_definitions(/DCPURIG_FEATURE_NVML)
