...
cpurig::CudaDevice::CudaDevice(uint32_t index, int32_t bfactor, int32_t bsleep) :
    m_index(index)
{
...
cpurig::CudaDevice::CudaDevice(CudaDevice &&other) noexcept :
...
void cpurig::CudaDevice::toJSON(rapidjson::Value &out, rapidjson::Document &doc) const
{
