...
rapidjson::Value cpurig::CudaConfig::toJSON(rapidjson::Document &doc) const
{
...
std::vector<cpurig::CudaLaunchData> cpurig::CudaConfig::get(const Miner *miner, const Algorithm &algorithm, const std::vector<CudaDevice> &devices) const
{
...
void cpurig::CudaConfig::read(const rapidjson::Value &value)
{
    if (value.IsObject()) {
...
void cpurig::CudaConfig::generate()
{
    if (generated) {
        return;
    }
...
void cpurig::CudaConfig::setDevicesHint(const char *devicesHint)
{
