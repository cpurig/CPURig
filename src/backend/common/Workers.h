...
#ifndef CPURIG_WORKERS_H
#define CPURIG_WORKERS_H
...
{
public:
    CPURIG_DISABLE_COPY_MOVE(Workers)
...
template<class T>
void cpurig::Workers<T>::jobEarlyNotification(const Job &job)
{
