...
uint64_t cpurig::HashrateInterpolator::interpolate(uint64_t timeStamp) const
{
    timeStamp -= LagMS;
...
void cpurig::HashrateInterpolator::addDataPoint(uint64_t count, uint64_t timeStamp)
{
    std::lock_guard<std::mutex> l(m_lock);
