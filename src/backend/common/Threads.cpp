...
template <class T>
const T &cpurig::Threads<T>::get(const String &profileName) const
{
    static T empty;
...
template <class T>
size_t cpurig::Threads<T>::read(const rapidjson::Value &value)
{
...
template <class T>
cpurig::String cpurig::Threads<T>::profileName(const Algorithm &algorithm, bool strict) const
{
...
template <class T>
void cpurig::Threads<T>::toJSON(rapidjson::Value &out, rapidjson::Document &doc) const
{
    using namespace rapidjson;
