...
cpurig::OclContext::OclContext(const OclDevice &device)
{
...
bool cpurig::OclContext::init(const std::vector<OclDevice> &devices, std::vector<OclLaunchData> &threads)
{
    if (!m_ctx) {
