...
std::vector<cpurig::OclPlatform> cpurig::OclPlatform::get()
{
...
rapidjson::Value cpurig::OclPlatform::toJSON(rapidjson::Document &doc) const
{
...
std::vector<cpurig::OclDevice> cpurig::OclPlatform::devices() const
{
...
cpurig::String cpurig::OclPlatform::extensions() const
{
    return OclLib::getString(id(), CL_PLATFORM_EXTENSIONS);
}


cpurig::String cpurig::OclPlatform::name() const
{
    return OclLib::getString(id(), CL_PLATFORM_NAME);
}


cpurig::String cpurig::OclPlatform::profile() const
{
    return OclLib::getString(id(), CL_PLATFORM_PROFILE);
}


cpurig::String cpurig::OclPlatform::vendor() const
{
    return OclLib::getString(id(), CL_PLATFORM_VENDOR);
}


cpurig::String cpurig::OclPlatform::version() const
{
