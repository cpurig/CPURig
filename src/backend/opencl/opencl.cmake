if (BUILD_STATIC AND CPURIG_OS_UNIX AND WITH_OPENCL)
...
if (WITH_OPENCL)
    add_definitions(/DCPURIG_FEATURE_OPENCL)
    ...
    if (WITH_STRICT_CACHE)
        add_definitions(/DCPURIG_STRICT_OPENCL_CACHE)
    else()
        remove_definitions(/DCPURIG_STRICT_OPENCL_CACHE)
    endif()

    if (WITH_INTERLEAVE_DEBUG_LOG)
        add_definitions(/DCPURIG_INTERLEAVE_DEBUG)
    endif()

    if (WITH_ADL AND (CPURIG_OS_WIN OR CPURIG_OS_LINUX))
        add_definitions(/DCPURIG_FEATURE_ADL)
       ...
       remove_definitions(/DCPURIG_FEATURE_ADL)
    endif()
else()
    remove_definitions(/DCPURIG_FEATURE_OPENCL)
    remove_definitions(/DCPURIG_FEATURE_ADL)
