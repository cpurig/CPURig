...
cpurig::OclRxJitRunner::OclRxJitRunner(size_t index, const OclLaunchData &data) : OclRxBaseRunner(index, data)
{
}


cpurig::OclRxJitRunner::~OclRxJitRunner()
{
...
void cpurig::OclRxJitRunner::execute(uint32_t iteration)
{
...
void cpurig::OclRxJitRunner::init()
{
...
bool cpurig::OclRxJitRunner::loadAsmProgram()
{
