...
cpurig::OclRxBaseRunner::OclRxBaseRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
cpurig::OclRxBaseRunner::~OclRxBaseRunner()
{
...
void cpurig::OclRxBaseRunner::run(uint32_t nonce, uint32_t *hashOutput)
{
...
void cpurig::OclRxBaseRunner::set(const Job &job, uint8_t *blob)
{
...
size_t cpurig::OclRxBaseRunner::bufferSize() const
{
...
void cpurig::OclRxBaseRunner::build()
{
    OclBaseRunner::build();
...
void cpurig::OclRxBaseRunner::init()
{
    OclBaseRunner::init();
