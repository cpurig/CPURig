...
cpurig::OclCnRunner::OclCnRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
cpurig::OclCnRunner::~OclCnRunner()
{
    delete m_cn0;
    delete m_cn1;
    delete m_cn2;
...
size_t cpurig::OclCnRunner::bufferSize() const
{
...
void cpurig::OclCnRunner::run(uint32_t nonce, uint32_t *hashOutput)
{
...
void cpurig::OclCnRunner::set(const Job &job, uint8_t *blob)
{
