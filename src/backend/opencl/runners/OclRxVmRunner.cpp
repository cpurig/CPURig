...
cpurig::OclRxVmRunner::OclRxVmRunner(size_t index, const OclLaunchData &data) : OclRxBaseRunner(index, data)
{
}


cpurig::OclRxVmRunner::~OclRxVmRunner()
{
    delete m_init_vm;
    delete m_execute_vm;
...
size_t cpurig::OclRxVmRunner::bufferSize() const
{
    return OclRxBaseRunner::bufferSize() + (align(2560 * m_intensity));
}


void cpurig::OclRxVmRunner::build()
{
...
void cpurig::OclRxVmRunner::execute(uint32_t iteration)
{
...
void cpurig::OclRxVmRunner::init()
{
