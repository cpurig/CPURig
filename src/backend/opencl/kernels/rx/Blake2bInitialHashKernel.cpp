...
void cpurig::Blake2bInitialHashKernel::enqueue(cl_command_queue queue, size_t threads)
{
...
void cpurig::Blake2bInitialHashKernel::setArgs(cl_mem out, cl_mem blockTemplate)
{
...
void cpurig::Blake2bInitialHashKernel::setBlobSize(size_t size)
{
...
void cpurig::Blake2bInitialHashKernel::setNonce(uint32_t nonce)
{
