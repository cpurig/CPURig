...
void cpurig::Cn2RyoKernel::enqueue(cl_command_queue queue, uint32_t nonce, size_t threads)
{
...
void cpurig::Cn2RyoKernel::setArgs(cl_mem scratchpads, cl_mem states, cl_mem output, uint32_t threads)
{
...
void cpurig::Cn2RyoKernel::setTarget(uint64_t target)
{
