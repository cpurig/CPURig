...
void cpurig::Cn1RyoKernel::enqueue(cl_command_queue queue, size_t threads, size_t worksize)
{
...
void cpurig::Cn1RyoKernel::setArgs(cl_mem scratchpads, cl_mem states, uint32_t threads)
{
