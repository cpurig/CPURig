...
void cpurig::ConfigTransform::finalize(rapidjson::Document &doc)
{
...
void cpurig::ConfigTransform::transform(rapidjson::Document &doc, int key, const char *arg)
{
...
void cpurig::ConfigTransform::transformBoolean(rapidjson::Document &doc, int key, bool enable)
{
    switch (key) {
    case IConfig::HugePagesKey: /* --no-huge-pages */
...
void cpurig::ConfigTransform::transformUint64(rapidjson::Document &doc, int key, uint64_t arg)
{
    using namespace rapidjson;
...
#ifdef CPURIG_FEATURE_BENCHMARK
void cpurig::ConfigTransform::transformBenchmark(rapidjson::Document &doc, int key, const char *arg)
{
    switch (key) {
    case IConfig::AlgorithmKey: /* --algo */
