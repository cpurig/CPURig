...
#ifndef CPURIG_USAGE_H
#define CPURIG_USAGE_H
...
static inline const std::string &usage()
{
    ...
    u += "  -a, --algo=ALGO               mining algorithm https://cpurig.com/docs/algorithms\n";
...
#   endif
    ...
    u += "      --donate-over-proxy=N     control donate over cpurig-proxy feature\n";
...
#   ifdef CPURIG_FEATURE_CUDA
    ...
    u += "      --cuda-loader=PATH        path to CUDA plugin (cpurig-cuda.dll or libcpurig-cuda.so)\n";
