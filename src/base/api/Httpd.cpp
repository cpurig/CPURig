...
cpurig::Httpd::~Httpd() = default;


bool cpurig::Httpd::start()
{
...
void cpurig::Httpd::onConfigChanged(Config *config, Config *previousConfig)
{
...
void cpurig::Httpd::onHttpData(const HttpData &data)
{
...
int cpurig::Httpd::auth(const HttpData &req) const
{
