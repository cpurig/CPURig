...
void cpurig::Api::request(const HttpData &req)
{
...
void cpurig::Api::onConfigChanged(Config *config, Config *previousConfig)
{
...
void cpurig::Api::exec(IApiRequest &request)
{
    using namespace rapidjson;
...
void cpurig::Api::genId(const String &id)
{
...
void cpurig::Api::genWorkerId(const String &id)
{
