...
char *cpurig::Platform::createUserAgent()
{
...
bool cpurig::Platform::hasKeepalive()
{
...
bool cpurig::Platform::setThreadAffinity(uint64_t cpu_id)
{
...
void cpurig::Platform::setProcessPriority(int priority)
{
    if (priority == -1) {
        return;
    }
...
void cpurig::Platform::setThreadPriority(int priority)
{
    if (priority == -1) {
        return;
    }
...
bool cpurig::Platform::isOnBatteryPower()
{
...
uint64_t cpurig::Platform::idleTime()
{
    LASTINPUTINFO info{};
