...
#ifndef CPURIG_SINGLEPOOLSTRATEGY_H
#define CPURIG_SINGLEPOOLSTRATEGY_H
...
{
public:
    CPURIG_DISABLE_COPY_MOVE_DEFAULT(SinglePoolStrategy)
...
#endif /* CPURIG_SINGLEPOOLSTRATEGY_H */
