...
cpurig::AutoClient::AutoClient(int id, const char *agent, IClientListener *listener) :
    EthStratumClient(id, agent, listener)
{
}


bool cpurig::AutoClient::handleResponse(int64_t id, const rapidjson::Value &result, const rapidjson::Value &error)
{
...
bool cpurig::AutoClient::parseLogin(const rapidjson::Value &result, int *code)
{
...
int64_t cpurig::AutoClient::submit(const JobResult &result)
{
...
void cpurig::AutoClient::parseNotification(const char *method, const rapidjson::Value &params, const rapidjson::Value &error)
{
