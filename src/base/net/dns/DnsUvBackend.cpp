...
cpurig::DnsUvBackend::DnsUvBackend()
{
...
std::shared_ptr<cpurig::DnsRequest> cpurig::DnsUvBackend::resolve(const String &host, IDnsListener *listener, uint64_t ttl)
{
...
bool cpurig::DnsUvBackend::resolve(const String &host)
{
...
void cpurig::DnsUvBackend::onResolved(int status, addrinfo *res)
{
...
void cpurig::DnsUvBackend::onResolved(uv_getaddrinfo_t *req, int status, addrinfo *res)
{
