...
// since 2019.05.16, Version 1.29.0 (Stable) https://github.com/cpurig/cpurig/pull/1889
...
cpurig::Async::Async(Callback callback) : d_ptr(new AsyncPrivate())
{
...
cpurig::Async::Async(IAsyncListener *listener) : d_ptr(new AsyncPrivate())
{
