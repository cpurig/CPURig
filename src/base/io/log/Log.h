...
#define LOG_EMERG(x, ...)   cpurig::Log::print(cpurig::Log::EMERG,   x, ##__VA_ARGS__)
#define LOG_ALERT(x, ...)   cpurig::Log::print(cpurig::Log::ALERT,   x, ##__VA_ARGS__)
#define LOG_CRIT(x, ...)    cpurig::Log::print(cpurig::Log::CRIT,    x, ##__VA_ARGS__)
#define LOG_ERR(x, ...)     cpurig::Log::print(cpurig::Log::ERR,     x, ##__VA_ARGS__)
#define LOG_WARN(x, ...)    cpurig::Log::print(cpurig::Log::WARNING, x, ##__VA_ARGS__)
#define LOG_NOTICE(x, ...)  cpurig::Log::print(cpurig::Log::NOTICE,  x, ##__VA_ARGS__)
#define LOG_INFO(x, ...)    cpurig::Log::print(cpurig::Log::INFO,    x, ##__VA_ARGS__)
#define LOG_VERBOSE(x, ...) if (cpurig::Log::verbose() > 0) { cpurig::Log::print(cpurig::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V1(x, ...)      if (cpurig::Log::verbose() > 0) { cpurig::Log::print(cpurig::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V2(x, ...)      if (cpurig::Log::verbose() > 1) { cpurig::Log::print(cpurig::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V3(x, ...)      if (cpurig::Log::verbose() > 2) { cpurig::Log::print(cpurig::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V4(x, ...)      if (cpurig::Log::verbose() > 3) { cpurig::Log::print(cpurig::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V5(x, ...)      if (cpurig::Log::verbose() > 4) { cpurig::Log::print(cpurig::Log::INFO, x, ##__VA_ARGS__); }

#ifdef APP_DEBUG
#   define LOG_DEBUG(x, ...) cpurig::Log::print(cpurig::Log::DEBUG, x, ##__VA_ARGS__)
#else
#   define LOG_DEBUG(x, ...)
#endif

#if defined(APP_DEBUG) || defined(APP_DEVEL)
#   define LOG_DEBUG_ERR(x, ...)  cpurig::Log::print(cpurig::Log::ERR,     x, ##__VA_ARGS__)
#   define LOG_DEBUG_WARN(x, ...) cpurig::Log::print(cpurig::Log::WARNING, x, ##__VA_ARGS__)
#else
