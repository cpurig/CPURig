...
#ifdef SIGUSR1
static const int signums[cpurig::Signals::kSignalsCount] = { SIGHUP, SIGINT, SIGTERM, SIGUSR1 };
#else
static const int signums[cpurig::Signals::kSignalsCount] = { SIGHUP, SIGINT, SIGTERM };
#endif


cpurig::Signals::Signals(ISignalListener *listener)
    : m_listener(listener)
{
#   ifndef CPURIG_OS_WIN
...
void cpurig::Signals::onSignal(uv_signal_t *handle, int signum)
{
    switch (signum)
    {
    case SIGHUP:
