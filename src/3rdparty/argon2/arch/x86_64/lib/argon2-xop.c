...
void cpurig_ar2_fill_segment_xop(const argon2_instance_t *instance, argon2_position_t position)
{
    fill_segment_128(instance, position);
}

extern int cpu_flags_has_xop(void);
int cpurig_ar2_check_xop(void) { return cpu_flags_has_xop(); }

#else

void cpurig_ar2_fill_segment_xop(const argon2_instance_t *instance, argon2_position_t position) {}
int cpurig_ar2_check_xop(void) { return 0; }
